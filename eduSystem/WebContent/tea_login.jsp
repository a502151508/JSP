...
<h1><b>教师登录/Login &nbsp &nbsp &nbsp <small><small></small><small><a href="stu_login.jsp">学生登陆</a> &nbsp &nbsp<a href="adm_login.jsp">管理员登陆</a></small></small></</b></h1>
<hr />
<body>
<form action="Validate_Tea" method="post">
...
<input type = "reset" value="重置"> </td>   &nbsp &nbsp &nbsp
