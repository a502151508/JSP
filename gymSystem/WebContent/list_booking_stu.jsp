...
try
{
	...
	out.println("<tr><th>项目名称</th><th>时间</th><th>入场信息</th><th>学号</th><th>退票</th></tr>");
	...
	while(rs.next())
	{
		...
		out.println("<td><a href=\"book_delete.jsp?resId="+resId+"&stunum="+stuNum+"\">退票</a>");
		out.println("</tr>");
		}
	}
}
...
<li><a href="list_reserve_stu.jsp">返回主页</a></li>
</ul></div>
</center>
</body>
</html>